...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Fonts -->
        <link href="/backoffice/https://fonts.bunny.net/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="#anciens" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-diamond purple_color"></i> <span>Elements</span></a>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="/backoffice/images/layout_img/msg2.png" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="/backoffice/images/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                                          <span>
                  ...
                  <div class="container-fluid">
                     <div class="footer">
                        <p>Copyright © 2018 Designed by html.design. All rights reserved.<br><br>
                           Distributed By: <a href="/backoffice/https://themewagon.com/">ThemeWagon</a>
                        </p>
                     </div>
                  </div>
               </div>
      ...
      <!-- wow animation -->
      <script src="/backoffice/js/animate.js"></script>
      <!-- select country -->
      <script src="/backoffice/js/bootstrap-select.js"></script>
      <!-- owl carousel -->
      <script src="/backoffice/js/owl.carousel.js"></script> 
      <!-- chart js -->
      <script src="/backoffice/js/Chart.min.js"></script>
      <script src="/backoffice/js/Chart.bundle.min.js"></script>
      <script src="/backoffice/js/utils.js"></script>
      <script src="/backoffice/js/analyser.js"></script>
      <!-- nice scrollbar -->
      <script src="/backoffice/js/perfect-scrollbar.min.js"></script>
      <script>
         var ps = new PerfectScrollbar('#sidebar');
      </script>
      <!-- custom js -->
      <script src="/backoffice/js/custom.js"></script>
      <script src="/backoffice/js/chart_custom_style1.js"></script>
   </body>
</html>
c:\xampp\htdocs\pluto-1.0.0\css c:\xampp\htdocs\pluto-1.0.0\fonts c:\xampp\htdocs\pluto-1.0.0\images c:\xampp\htdocs\pluto-1.0.0\js